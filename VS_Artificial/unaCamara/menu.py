...
def funcion1():
    exec(open('VS_Artificial/unaCamara/Calibrado.py').read())
       

def funcion2():
    exec(open('VS_Artificial/unaCamara/VS_AR.py').read())

def funcion3():
    exec(open('VS_Artificial/unaCamara/VS_ARFoto.py').read())

def funcion4():
    exec(open('VS_Artificial/unaCamara/VS_ARVideo.py').read())
